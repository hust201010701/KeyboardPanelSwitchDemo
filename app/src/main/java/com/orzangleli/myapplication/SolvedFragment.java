...
public class SolvedFragment extends Fragment {
    ...
    private KBPanelConflictLayout mPanel;
    private KBRootConflictLayout mRoot;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mRoot = (KBRootConflictLayout) inflater.inflate(R.layout.fragment_solved, container, false);
        dp60 = dp2px(60);
        sp = container.getContext().getSharedPreferences("keyboard", Context.MODE_PRIVATE);
        initTitle("解决切换键盘冲突");
        initView(mRoot);
        return mRoot;
    }
        ...
        mGlobalLayoutListener = new ViewTreeObserver.OnGlobalLayoutListener() {
            ...
            public void onGlobalLayout() {
                ...
                if (Math.abs(displayHeight - mOldDecorViewHeight) > dp60) {
                    ...
                    if (keyboardHeight != 0) {
                        sp.edit().putInt("height", keyboardHeight).commit();
                    }
                }
            }
        };
